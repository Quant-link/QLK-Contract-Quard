                  ...
                  <div className="space-y-3">
                    ...
                    {finding.code_snippet && (
                      <div className="bg-gray-50 p-3 rounded-md">
                        <div className="text-xs text-gray-500 mb-1">Code Pattern:</div>
                        <pre className="text-sm font-mono whitespace-pre-wrap">{finding.code_snippet}</pre>
                      </div>
                    )}
                    
                    <div className="bg-blue-50 p-3 rounded-md">
                      <div className="text-xs text-blue-600 mb-1 font-medium">AI Recommendation:</div>
